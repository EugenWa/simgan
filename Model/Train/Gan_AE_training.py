...
if __name__ == "__main__":
    ...
    # generator
    config_name_gan      = 'GAN_Sins_Unsuperv.ini'#sys.argv[1]  #'gan_cfg.ini'#sys.argv[1] #'gan_cfg_IDo_1.ini'
    config_name_ae       = 'Basic_nRES_AE_Sins_unsuperV_ID.ini'#sys.argv[2]
    degraded_dataset     = 'B3'#sys.argv[3]
