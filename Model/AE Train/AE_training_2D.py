...
if __name__ == "__main__":
    ...
    xA_train_img_only, xA_target, xB_train, xa_val_img_only, xa_val_target, xb_val, xA_test_img_only, xA_test_target, xB_test = Data_load.Load_Data_Tensor_Split(degraded_dataset, validation_split, 0)
