...
from Model.Modules.Generators.Generator_Basic_Residual import build_basic_decoder_residual, build_basic_encoder_residual, build_basic_transformation_layers
...
class Basic_nRES_ResidualAE_2D:
    def __init__(self, ae_name, img_shape, cfg, AE_eval):
        ...
        print('Basic nRes Residual AE 2D: ')
